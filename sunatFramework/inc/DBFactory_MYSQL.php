 ...
 */
class DBFactory_MYSQL extends DBFactory
{
    /** SC_Query インスタンス */
    public $objQuery;
    ...
    {
        $objQuery =& mysql_db::getSingletonInstance($dsn);
    ...
    {
        $objQuery =& mysql_db::getSingletonInstance();
...
__EOS__;
     ...
     *
     * @param  mysql_db $objQuery SC_Query インスタンス
     * @return void
     */
    public function initObjQuery(mysql_db &$objQuery)
    {
