...
namespace Plugin\MultiChargePlugin\Service\PurchaseFlow\Processor;
    ...
    public function process(ItemHolderInterface $itemHolder, PurchaseContext $context)
    {
        ...
        foreach ($itemHolder->getItems() as $item) {
            if ($item->getProcessorName() == PaymentChargePreprocessor::class) {
                ...
                $carriage_repository = $this->entitymanager->getRepository('Plugin\MultiChargePlugin\Entity\Carriage');
