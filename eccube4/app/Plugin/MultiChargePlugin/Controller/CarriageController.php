...
namespace Plugin\MultiChargePlugin\Controller;
...
use Plugin\MultiChargePlugin\Form\Type\Admin\CarriageType;
...
class CarriageController extends AbstractController
{
    ...
    {
        $carriage = new \Plugin\MultiChargePlugin\Entity\Carriage();
